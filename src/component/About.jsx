...
function About() {
  return (
    <section
      id="About"
      className=" min-h-screen flex items-center  pt-60 sm:pt-0"
    >
            ...
            <div className="w-full lg:w-2/4  mt-5">
              ...
              >
                <p className=" text-lg text-gray-300 ">
                  ...
                  web development and a keen eye for design, I specialize in
                  creating high-performance, user-friendly applications that
                  make an impact. Whether it's building responsive websites or
                  developing innovative solutions, I'm always eager to learn and
                  grow in the ever-evolving world of technology.
                </p>
              </motion.div>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                ...
                <div className="flex gap-4 mt-2">
                  ...
                  <a href="#Contact">
                    <button className=" flex items-center gap-2 text-sm bg-transparent border-gray-600 border hover:shadow-lg hover:shadow-gray-600/50 hover:-translate-y-1 transition-transform text-white font-semibold py-4 px-6 rounded-lg mt-2 ">
                      <BookUser size={20} color="white" strokeWidth={3} />{" "}
                      Contact
                    </button>
                  </a>
                </div>
            ...
            <div className="bg-gray-700/30 col-span-3 sm:col-span-1 text-white p-6 rounded-xl relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-300 mt-4">
                  My approach to software development is centered around
